...
if (!function_exists( 'devdmbootstrap_setup' ) ) {
    ...
    function devdmbootstrap_setup()
    {
        ...
        add_image_size( 'feature-large', 600, 600 );

        // Register the three useful image sizes for use in Add Media modal
        add_filter( 'image_size_names_choose', 'wpshout_custom_sizes' );
        function wpshout_custom_sizes( $sizes ) {
            return array_merge( $sizes, array(
                'feature-large' => __( 'Feature Large' )
            ) );
        }
...
wp_enqueue_style( 'wpb-google-fonts', 'https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700,800,900|Muli:300,300i,400,400i,600,600i,700,700i|Roboto:300,300i,400,400i,500,500i,700,700i', false );
}
